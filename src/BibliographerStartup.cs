...
namespace bibliographer
{
    ...
    public class BibliographerStartup
    {
        public static void Main (string[] args)
        {
            ...
            window.indexerThread.Start();
            window.alterationMonitorThread.Start();
            
            Gtk.Application.Run ();
            
            window.indexerThread.Abort();
            window.alterationMonitorThread.Abort();
            window.indexerThread.Join();
            window.alterationMonitorThread.Join();
